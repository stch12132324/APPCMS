                    ...
                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14">
                      ...
                      <tr>
                        ...
                        <td valign="top"><span style="color:#000000;font-size:12px;">
                          <input name="product_name" type="text" size="18" maxlength="50" value="335.com在线充值" font style="color:#000000;font-size:14px;">
                        </span></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">付款金额：</td>
                        <td valign="top"><input type="text" name="order_price" maxlength="50" size="18" onKeyUp="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="100" font style="color:#000000;font-size:14px;"> 
                        元（格式：500.01）</td>
                      </tr>
                       <tr>
                        <td align="right" valign="top">接口类型：</td>
                        <td valign="top"><span style="color:#000000;font-size:12px;">
                      ...
                      <tr>
                        ...
                        <td valign="top"><div id="tenpayBankList"></div>
                        <input type="hidden" name="bank_type_value" value="0"  id="bank_type_value">
